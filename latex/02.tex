...
\subsection*{Objetivo}
Construir coletivamente um panorama da história do design gráfico, utilizando o livro do OpenTextBC como fonte e o ChatGPT como ferramenta de síntese.
...
\begin{enumerate}[nosep]
  ...
  \item O grupo acessará o capítulo correspondente no livro \url{https://opentextbc.ca/graphicdesign/} e, com auxílio do ChatGPT, produzirá um resumo estruturado contendo:
  \begin{itemize}[nosep]
