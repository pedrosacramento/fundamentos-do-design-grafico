...
\begin{center}
\includegraphics[width=0.35\textwidth]{latex/monet.jpg}
...
\medskip
\noindent Mesmo diante de uma obra de grande valor artístico, é possível que as pessoas simplesmente não percebam o que têm diante de si. O valor das criações humanas precisa ser comunicado. Conectar uma criação a diferentes áreas --- teatro, dança, arquitetura, fotografia, literatura, música --- pode ser um bom caminho para ajudar as pessoas a compreenderem a profundidade de algo que criamos, inclusive seu valor financeiro.
...
% Fim da Aula 02
% última atualização: inclusão da imagem monet.jpg
